    ...
    public static string GetStatValue(Player player, StructureStatsUpgrade structureStatsUpgrade)
    {
        ...
        switch(structureStatsUpgrade)
        {
            ...
            case StructureStatsUpgrade.StructureMaxHealth:
                stat = player.stats.structureStats.structureMaxHealthMult.ToString("#0.0");
                return stat;
            ...
            case StructureStatsUpgrade.TurretSensors:
                stat = TurretManager.Instance.turretGunList[0].detectRange.ToString("#0");
                return stat;
        }
    ...
    public static string GetUpgAmount(PlayerStatsUpgrade playerStatsUpgrade, UpgradeManager upgradeSystem)
    {
        ...
        switch (playerStatsUpgrade)
        {
            ...
            case PlayerStatsUpgrade.SprintFactor:
                ...
                return amount;
            case PlayerStatsUpgrade.PlayerReloadSpeed:
                amount = "+" + PlayerReloadSpeedUpgrade.UpgAmount.ToString();
                return amount;
            case PlayerStatsUpgrade.PlayerAccuracy:
