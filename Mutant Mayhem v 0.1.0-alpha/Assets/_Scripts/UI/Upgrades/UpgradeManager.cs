...
public class UpgradeManager : MonoBehaviour
{
    ...
    public void Initialize()
    {
        ...
        if (uiUpgAppliedFX != null)
            Destroy(uiUpgAppliedFX.gameObject);
        playerUpgAppliedFX = Instantiate(playerUpgAppliedPrefab).GetComponent<ParticleSystem>();
        uiUpgAppliedFX = Instantiate(uiUpgAppliedPrefab).GetComponent<ParticleSystem>();
        ...
        structureStatsUpgBaseCosts[StructureStatsUpgrade.MaxTurrets] = 3000;
    ...
    public void PlayUpgradeButtonEffect()
    {
        ...
        PlayUpgradeEffectAt(player.transform.position);
    }

    public void PlayUpgradeEffectAt(Vector3 pos)
    {
